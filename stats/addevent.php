...
// addConferenceEvent($title,$presenter,$price,$date,$time,$age,$limit=20,$description)
   ...
   if(addConferenceEvent($_REQUEST['eventName'],$_REQUEST['eventPresenter'],$_REQUEST['eventPrice'],$_REQUEST['eventDate'],$_REQUEST['eventTime'],$_REQUEST['eventAges'],$_REQUEST['eventLimit'],$_REQUEST['eventDescription'],$_REQUEST["eventLocation"]))
   {
       $a=array(
           "Admin Home"=>"index.php",
           "Add Another Event" =>"index.php?z=addevents"
       );
       printHeader($a);
...
<option value=\"June 16 - 19th\">June 16 - 19th</option>
...
<option value=\"4pm - 5:30pm\">Afternoon Aftercare</option>
 ...
 <tr><td>Location</td><td><input type=text name=eventLocation size=40 maxlength=30/> </td></tr>       
